  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://yourdomain.com/skills" /> {/* Replace */}
        <meta property="og:image" content="https://yourdomain.com/assets/images/og-skills.png" /> {/* Specific OG image */}
